...
var questions = [
    [ "Michelangelo’s David was…", "16ft tall", "17ft tall", "18ft tall", "B" ],
	[ "Leonardo da Vinci was not...", "architect", "painter", "a musician", "C" ],
	[ "What’s weird about the Mona Lisa?", "She has no facial hair.", "There’s no sfumato!", "The medium was actually not paint.", "A" ],
	[ "Renaissance painting was considered a...", "gentleman's affair", "a woman's affair", "craftsmen's affair", "C" ]
];
function _(x) {
...
//	("test_status").innerHTML = "Question "+(pos+1)+" of "+questions.length;
	...
	test.innerHTML += "<button onclick='checkAnswer()'>Next</button>"; //changed name of button to 'Next'
}
